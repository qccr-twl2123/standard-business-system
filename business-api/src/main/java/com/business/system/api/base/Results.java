package com.business.system.api.base;

import com.business.system.api.enums.ErrorCodeEmun;
...
public class Results {
    ...
    public static <T> Result<T> newFailedResult(ErrorCodeEmun errorCodeEmun) {
        return newResult(null, errorCodeEmun.getDesc(), false, errorCodeEmun.getCode());
    }
